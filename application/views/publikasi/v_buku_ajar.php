                          ...
                          foreach($query as $row){
                            ...
                            <tr>
                              ...
                              <td><b><?php echo $row->nama_dosen; ?></b><br>
                                NIP :&nbsp;<span class="font_color_blue"><?php echo $row->NIDN;?></span><br>
                                <?php
                                    if($row->nama_dosen1 != NULL){
                                ?>         
                                        <b><?php echo $row->nama_dosen1; ?></b><br>
                                        NIP :&nbsp;<span class="font_color_blue"><?php $query_tampil_nidn1=$this->db->query('SELECT * FROM t_buku_ajar JOIN t_login ON t_login.username=t_buku_ajar.nama_dosen1 WHERE id_buku_ajar='.$row->id_buku_ajar);
                                    ...
                                    ?>         
                                        ...
                                        NIP :&nbsp;<span class="font_color_blue"><?php $query_tampil_nidn1=$this->db->query('SELECT * FROM t_buku_ajar JOIN t_login ON t_login.username=t_buku_ajar.nama_dosen2 WHERE id_buku_ajar='.$row->id_buku_ajar);
                                        foreach ($query_tampil_nidn1->result_array() as $nidn1) {
                                          echo $nidn1['NIDN'];                
                                        } 
                                        ?></span><br>                                   
