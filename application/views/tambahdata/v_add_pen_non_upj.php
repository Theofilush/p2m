                ...
                <div class="x_content">                    
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                            <div class="x_title">
                                <h2>Penelitian Sumber Dana non-Universitas Pembangunan Jaya</h2>
                            ...
                            <div class="x_content">
                                ...
                                <?php
                                    $atribut = array(
                                        ...
                                        echo form_open_multipart('databaru/newpenelitiannonupj/savedok',$atribut);
                                ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?php echo site_url() ?>penelitian/PenelitianDanaNonUPJ" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Batal</a>
